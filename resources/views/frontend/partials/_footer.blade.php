    ...
    <div class="container pb-5">
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Brgy. Atabay, Hilongos Leyte</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+012 345 67890</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>jcjsalonms@gmail.com</p>
            ...
            <div class="col-lg-5 col-md-12">
                <div class="row gy-5 g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <a class="btn btn-link" href="#service">Massage</a>
                        <a class="btn btn-link" href="#service">Haircut</a>
                        <a class="btn btn-link" href="#service">SPA</a>
                    </div>
                </div>
            </div>
        </div>
